...
DEFAULT_CSV_FORMAT = \
    ...
    "7$shape=forme,\n" \
    "8$distance=distance,\n" \
    "10$sonar4.mean=sonar4 mean distance,\n" \
    "11$sonar4.std_dev=sonar4 std dev,\n" \
    "12$sonar4.min=sonar4 min,\n" \
    "13$sonar4.sample_count=sonar4 sample count,\n" \
    "14$sonar4.duration=sonar4 duration,\n" \
	"15$sonar4.delta=sonar4 delta,\n" \
    "16$sonar3.mean=sonar3 mean distance,\n" \
    "17$sonar3.std_dev=sonar3 std dev,\n" \
    "18$sonar3.min=sonar3 min,\n" \
    "19$sonar3.sample_count=sonar3 sample count,\n" \
    "20$sonar3.duration=sonar3 duration,\n" \
	"21$sonar3.delta=sonar3 delta,\n" \
    "22$sonar2.mean=sonar2 mean distance,\n" \
    "23$sonar2.std_dev=sonar2 std dev,\n" \
    "24$sonar2.min=sonar2 min,\n" \
    "25$sonar2.sample_count=sonar2 sample count,\n" \
    "26$sonar2.duration=sonar2 duration,\n" \
	"27$sonar2.delta=sonar2 delta,\n" \
