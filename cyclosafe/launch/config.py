...
sensors_list = [
	...
	SerialSensor(
		...
		port="/dev/ttyS0",
		transform=["--x", "0.155", "--y", "0.02", "--z", "-0.035", "--roll", "0", "--pitch", "0", "--yaw", "0", "--frame-id", "board", "--child-frame-id", "lidar2_tf_mini_plus/range"],
		topic="range",
		color="green",
		parameters=[{
			'model': 'tf-mini-plus',
	...
	SerialSensor(
		...
		port='/dev/ttyS0',
		transform=["--x", "0.10", "--y", "0.026", "--z", "-0.035", "--roll", "0", "--pitch", "0", "--yaw", "0", "--frame-id", "board", "--child-frame-id", "lidar2_tf_02/range"],
		topic="range",
		color="green",
		parameters=[{
			'model': 'tf-02',
